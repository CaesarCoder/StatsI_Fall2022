...
\begin{enumerate}
	...
	Create a new variable \texttt{professional} by recoding the variable \texttt{type} so that professionals are coded as $1$, and blue and white collar workers are coded as $0$ (Hint: \texttt{ifelse}).
		\lstinputlisting[language=R, firstline=1, lastline=11]{PS4.R}
	\vspace{6cm}
	
	
	\item [(b)]
	Run a linear model with \texttt{prestige} as an outcome and \texttt{income}, \texttt{professional}, and the interaction of the two as predictors (Note: this is a continuous $\times$ dummy interaction.)
		\lstinputlisting[language=R, firstline=14, lastline=19]{PS4.R}
	
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Sat, Dec 03, 2022 - 00:01:28
...
\newpage
	...
	\lstinputlisting[language=R, firstline=34, lastline=37]{PS4.R}
	$\hat{y} = 1 $
	...
	\lstinputlisting[language=R, firstline=40, lastline=43]{PS4.R}
	$\hat{y} =  25.761 $
...
\begin{enumerate}
	...
	P-value:\\
	 \lstinputlisting[language=R, firstline=56, lastline=58]{PS4.R} 
	 $p-value = 0.0097 < 0.05$\\
	 Conclusion: we can deny the null hypothesis that the slope of having these yard signs in a precinct is 0. 
	...
	\lstinputlisting[language=R, firstline=64, lastline=67]{PS4.R}
	P-value:\\
	\lstinputlisting[language=R, firstline=68, lastline=70]{PS4.R} 
	$p-value = 0.0016 < 0.05$\\
	Conclusion: we can deny the null hypothesis that the slope of being next to precincts with yard signs is 0. 
